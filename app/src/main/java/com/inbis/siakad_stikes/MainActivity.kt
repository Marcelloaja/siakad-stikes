...
//        supportActionBar?.hide()
        ...
        val sizeInDp = if (metrics.widthPixels > 1080) 32 else 20
        binding.navView.itemIconSize = TypedValue.applyDimension(
            TypedValue.COMPLEX_UNIT_DIP, sizeInDp.toFloat(), metrics
        ).toInt()
